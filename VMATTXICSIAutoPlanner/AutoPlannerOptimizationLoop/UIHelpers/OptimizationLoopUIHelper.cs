...
namespace AutoPlannerOptimizationLoop.UIHelpers
{
    public static class OptimizationLoopUIHelper
    {
        ...
        public static string GetPlanObjectivesHeader()
        {
            ...
            sb.AppendLine("--------------------------------------------------------------------------");
            sb.AppendLine(String.Format("{0, -16} | {1, -16} | {2, -10} | {3, -10} | {4, -9} |", "structure Id", "constraint type", "dose", "volume (%)", "dose units"));
            sb.Append("--------------------------------------------------------------------------");
            return sb.ToString();
        }
