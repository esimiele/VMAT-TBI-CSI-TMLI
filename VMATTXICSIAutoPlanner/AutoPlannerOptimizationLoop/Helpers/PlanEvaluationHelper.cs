...
namespace AutoPlannerOptimizationLoop.Helpers
{
    public static class PlanEvaluationHelper
    {
        ...
        /// <returns></returns>
        public static double GetDifferenceFromGoal(ExternalPlanSetup plan, IPlanConstraint goal, Structure theStructure)
        {
            ...
            {
                diff = plan.GetDVHCumulativeData(theStructure, goal.QueryDoseUnits == Units.Percent ? DoseValuePresentation.Relative : DoseValuePresentation.Absolute, VolumePresentation.Relative, 0.1).MeanDose.Dose - goal.QueryDose;
            }
