...
namespace AutoPlannerHelpers.Helpers
{
    public static class OptimizationSetupHelper
    {
        ...
        /// <param name="prescriptions"></param>
        /// <returns></returns>
        public static List<PlanOptimizationSetupModel> RetrieveOptConstraintsFromTemplate(AutoPlanTemplateBase selectedTemplate, List<PrescriptionModel> prescriptions)
        {
