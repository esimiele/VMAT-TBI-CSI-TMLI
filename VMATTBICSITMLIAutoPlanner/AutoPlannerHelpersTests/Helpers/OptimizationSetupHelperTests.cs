...
namespace AutoPlannerHelpers.Helpers.Tests
{
    ...
    public class OptimizationSetupHelperTests
    {
        ...
        public void CreateOptimizationConstraintListCSITestWithPlanTargets()
        {
            ...
            List<PlanOptimizationSetupModel> result = OptimizationSetupHelper.CreateOptimizationConstraintList(testTemplate, testPlanTargets, Enums.PlanType.VMAT_CSI);
        ...
        public void CreateOptimizationConstraintListCSITestNoPlanTargets()
        {
            ...
            List<PlanOptimizationSetupModel> result = OptimizationSetupHelper.CreateOptimizationConstraintList(testTemplate, new Dictionary<string, string> { }, Enums.PlanType.VMAT_CSI);
            OptimizationConstraintComparer comparer = new OptimizationConstraintComparer();
        ...
        public void CreateOptimizationConstraintListTBITestNoPlanTargets()
        {
            ...
            List<PlanOptimizationSetupModel> result = OptimizationSetupHelper.CreateOptimizationConstraintList(testTemplate, new Dictionary<string, string> { }, Enums.PlanType.VMAT_TBI);
            OptimizationConstraintComparer comparer = new OptimizationConstraintComparer();
